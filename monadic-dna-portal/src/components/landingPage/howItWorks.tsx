    ...
    return (
        <>
            ...
            >
                ...
                <Typography component="ol" className='sm:w-[520px]'>
                    <li className='py-3'>
                    ...
                    <li className='py-3'>
                        ...
                        <span>
                            ...
                            <Link href='https://snipperbot.xyz' target='_blank' rel='noopener noreferrer'>SnipperBot</Link>
                            {' '}and{' '}
                            <Link href='https://mtdog.xyz' target='_blank' rel='noopener noreferrer'>mtDog</Link>
